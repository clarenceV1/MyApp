...
/** 
 * DAO for table "BLOCK_REQUEST_DO".
*/
public class BlockRequestDODao extends AbstractDao<BlockRequestDO, Long> {

    public static final String TABLENAME = "BLOCK_REQUEST_DO";

    /**
     * Properties of entity BlockRequestDO.<br/>
    ...
    public BlockRequestDODao(DaoConfig config) {
        super(config);
    }
    
    public BlockRequestDODao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"BLOCK_REQUEST_DO\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"BLOCK_REQUEST_DO\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, BlockRequestDO entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, BlockRequestDO entity) {
        stmt.clearBindings();
    ...
    @Override
    public BlockRequestDO readEntity(Cursor cursor, int offset) {
        BlockRequestDO entity = new BlockRequestDO( //
    ...
    @Override
    public void readEntity(Cursor cursor, BlockRequestDO entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(BlockRequestDO entity, long rowId) {
        entity.setBlockId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(BlockRequestDO entity) {
        if(entity != null) {
    ...
    @Override
    public boolean hasKey(BlockRequestDO entity) {
