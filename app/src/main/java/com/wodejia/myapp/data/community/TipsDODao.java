...
/** 
 * DAO for table "TIPS_DO".
*/
public class TipsDODao extends AbstractDao<TipsDO, Long> {

    public static final String TABLENAME = "TIPS_DO";

    /**
     * Properties of entity TipsDO.<br/>
    ...
    public TipsDODao(DaoConfig config) {
        super(config);
    }
    
    public TipsDODao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TIPS_DO\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"TIPS_DO\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, TipsDO entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, TipsDO entity) {
        stmt.clearBindings();
    ...
    @Override
    public TipsDO readEntity(Cursor cursor, int offset) {
        TipsDO entity = new TipsDO( //
    ...
    @Override
    public void readEntity(Cursor cursor, TipsDO entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(TipsDO entity, long rowId) {
        entity.setTipId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(TipsDO entity) {
        if(entity != null) {
    ...
    @Override
    public boolean hasKey(TipsDO entity) {
